...
public class ResumeAll {
	...
	public ResumeAll(int resumeNo, int memberNo, String rname, String engName, Date birth, String gender, int postcode,
			...
			String school1, String schoolName1, Date schoolStartDate1, Date schoolFinishDate1, String education1,
			String school2, String schoolName2, Date schoolStartDate2, Date schoolFinishDate2, String education2,
			int resumeWorkno, Date workStartDate, Date workFinishDate, String workName, String workLevel,
			String workState, String workDetail, int resumeLicenseno, String licenseName, String licenseAgency,
			Date licenseDate, int resumeLanguageno, String languageName, String languageLevel, String languageTest,
			String languageScore, Date languageDate, int resumeActivityno, String activity, Date activityStartDate,
			Date activityFinishDate, String activityAgency, String activityWork, String activityDetail,
			int resumeProjectno, String projectPart, Date projectStartDate, Date projectFinishDate, String projectName,
			String projectWork, String projectDetail, int resumeAbroadno, String abroad, Date abroadStartDate,
			Date abroadFinishDate, String abroadCountury, String abroadAgency, String abroadDetail) {
		super();
	...
	public String toString() {
		return "ResumeAll [resumeNo=" + resumeNo + ", memberNo=" + memberNo + ", rname=" + rname + ", engName="
				...
				+ ", education2=" + education2 + ", resumeWorkno=" + resumeWorkno + ", workStartDate=" + workStartDate
